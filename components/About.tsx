...
const About: React.FC = () => {
  return (
    <div className="w-full h-screen flex flex-col space-y-12 items-center justify-center text-[#f0f0f0] relative overflow-hidden">
      <div className='flex flex-row space-x-3 w-2/3'>
        <div className='w-full rounded-xl p-6 border border-[#292929] flex flex-col items-start justify-center space-y-8 h-[295px]'>
          <h1 className='text-7xl font-extrabold'>{'<'} FullStackEngineer{' />'}</h1>
          <div className='text-xl text-[#8b8b8b]'>
        ...
        <div className='border border-[#292929] rounded-xl overflow-hidden w-fit h-[295px]'>
          <img src='/noah.jpg' alt='Noah' className='w-auto h-full aspect-square object-cover'/>
        </div>
      </div>
      <button className='border border-[#292929] p-3 rounded-xl text-[#f0f0f0] font-semibold space-x-2 items-center flex hover:scale-105 transition-all duration-300'>
